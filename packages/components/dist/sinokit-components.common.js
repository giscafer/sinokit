...
!function (e, t) {
   true ? module.exports = t(__webpack_require__(2)) : undefined;
}(window, function (e) {
  return function (e) {
    function t(t) {
    ...
    var o = window.webpackJsonpSINOKIT = window.webpackJsonpSINOKIT || [],
        a = o.push.bind(o);
    o.push = t, o = o.slice();
    ...
    function c(e, t) {
      if ("object" === e.type) {
        ...
        t ? e.required = [].concat(n) : delete e.required, function (e, t) {
          for (var n in e) "array" !== e[n].type && "object" !== e[n].type || c(e[n], t);
        }(e.properties, t);
      } else {
    ...
    const d = () => Math.random().toString(16).substr(2, 5),
          f = r.logger || (() => {}),
          h = e => ![void 0, null, ""].includes(e),
          p = e => {
      const t = {};
    ...
    e.exports = function () {
      ...
      var le = function () {
        ...
        return function (a, s) {
          ...
          for (var D = 0, L = l; D < u; ++D) {
            var T = d[D];
            "L" == L && "1" == T ? d[D] = "L" : n.test(T) && (L = T);
          }

          for (var O = 0; O < u; ++O) if (t.test(d[O])) {
            var j = void 0;
          ...
          for (var I, F = [], R = 0; R < u;) if (r.test(d[R])) {
            var W = R;
            ...
            for (var H = z; H < R;) if (i.test(d[H])) {
              z < H && (F.splice(P, 0, new o(1, z, H)), P += $);
              var B = H;

              for (++H; H < R && i.test(d[H]); ++H);

              F.splice(P, 0, new o(2, B, H)), P += $, z = H;
            } else ++H;

            z < R && F.splice(P, 0, new o(1, z, R));
          }

          return "ltr" == s && (1 == F[0].level && (I = a.match(/^\s+/)) && (F[0].from = I[0].length, F.unshift(new o(0, 0, I[0].length))), 1 == q(F).level && (I = a.match(/\s+$/)) && (q(F).to -= I[0].length, F.push(new o(0, u - I[0].length, u)))), "rtl" == s ? F.reverse() : F;
        };
      }();
      ...
      function ge(e) {
        ...
        if (t) for (var n = e.curOp.cursorActivityHandlers || (e.curOp.cursorActivityHandlers = []), r = 0; r < t.length; ++r) -1 == P(n, t[r]) && n.push(t[r]);
      }
      ...
      function Le(e) {
        if (null == Ae) {
          var t = T("span", "​");
          L(e, T("span", [t, document.createTextNode("x")])), 0 != e.firstChild.offsetHeight && (Ae = t.offsetWidth <= 1 && t.offsetHeight > 2 && !(a && s < 8));
        }

        var n = Ae ? T("span", "​") : T("span", " ", null, "display: inline-block; width: 1px; margin-right: -1px");
      ...
      function Te(e) {
        ...
        return D(e), !(!n || n.left == n.right) && (Me = r.right - n.right < 3);
      }
      ...
      var Oe,
        ...
        return !(!t || t.parentElement() != e) && 0 != t.compareEndPoints("StartToEnd", t);
          ...
          _e = "oncopy" in (Oe = T("div")) || (Oe.setAttribute("oncopy", "return;"), "function" == typeof Oe.oncopy),
          Ne = null,
          Ie = {},
          Fe = {};
      ...
      function $e(e, t) {
        R(t, Pe.hasOwnProperty(e) ? Pe[e] : Pe[e] = {});
      }
      ...
      function Xe(e) {
        ...
        for (var t = e.parent, n = P(t.lines, e), r = t.parent; r; t = r, r = r.parent) for (var i = 0; r.children[i] != t; ++i) n += r.children[i].chunkSize();
      ...
      function dt(e, t, n, r) {
        ...
        for (var a = n.state, s = function (r) {
          ...
          var s = e.state.overlays[r],
              l = 1,
              c = 0;
          n.state = !0, xt(e, t.text, s.mode, n, function (e, t) {
            for (var n = l; c < e;) {
              var r = i[l];
      ...
      function ht(e, t, n) {
        ...
        var o = function (e, t, n) {
          for (var r, i, o = e.doc, a = n ? -1 : t - (e.doc.mode.innerMode ? 1e3 : 100), s = t; s > a; --s) {
            ...
            var u = W(l.text, null, e.options.tabSize);
      ...
      function Ht(e, t, n) {
        ...
        for (var i = void 0, o = 0; o < t.markedSpans.length; ++o) if ((i = t.markedSpans[o]).marker.collapsed && !i.marker.widgetNode && i.from == n.to && (null == i.to || i.to != n.from) && (i.marker.inclusiveLeft || n.marker.inclusiveRight) && Ht(e, t, i)) return !0;
      }
      ...
      function Ut(e) {
        var t = e.display,
            n = e.doc;
        t.maxLine = Ge(n, n.first), t.maxLineLength = Vt(t.maxLine), t.maxLineChanged = !0, n.iter(function (e) {
          var n = Vt(e);
      ...
      function Jt(e, t) {
        ...
        for (var i = 0; i <= (t.rest ? t.rest.length : 0); i++) {
          var o = i ? t.rest[i - 1] : t.line,
              a = void 0;
          r.pos = 0, r.addToken = Zt, Te(e.display.measure) && (a = ce(o, e.doc.direction)) && (r.addToken = en(r.addToken, a)), r.map = [], nn(o, r, ft(e, o, t != e.display.externalMeasured && Xe(o))), o.styleClasses && (o.styleClasses.bgClass && (r.bgClass = N(o.styleClasses.bgClass, r.bgClass || "")), o.styleClasses.textClass && (r.textClass = N(o.styleClasses.textClass, r.textClass || ""))), 0 == r.map.length && r.map.push(0, 0, r.content.appendChild(Le(e.display.measure))), 0 == i ? (t.measure.map = r.map, t.measure.cache = {}) : ((t.measure.maps || (t.measure.maps = [])).push(r.map), (t.measure.caches || (t.measure.caches = [])).push({}));
        }
            ...
            for (var h = 0;;) {
              ...
              if ("\t" == p[0]) {
                var y = e.cm.options.tabSize,
                    b = y - e.col % y;
                (v = c.appendChild(T("span", K(b), "cm-tab"))).setAttribute("role", "presentation"), v.setAttribute("cm-text", "\t"), e.col += b;
        ...
        if (r) for (var a, s, l, c, u, d, f, h = i.length, p = 0, m = 1, g = "", v = 0;;) {
          if (v == p) {
            ...
            for (var y = [], b = void 0, x = 0; x < r.length; ++x) {
              ...
              if ("bookmark" == k.type && w.from == p && k.widgetNode) y.push(k);else if (w.from <= p && (null == w.to || w.to > p || k.collapsed && w.to == p && w.from == p)) {
                if (null != w.to && w.to != p && v > w.to && (v = w.to, c = ""), k.className && (l += " " + k.className), k.css && (s = (s ? s + ";" : "") + k.css), k.startStyle && w.from == p && (u += " " + k.startStyle), k.endStyle && w.to == v && (b || (b = [])).push(k.endStyle, w.to), k.title && ((f || (f = {})).title = k.title), k.attributes) for (var C in k.attributes) (f || (f = {}))[C] = k.attributes[C];
          ...
          for (var M = Math.min(h, v);;) {
            if (g) {
              ...
              if (!d) {
                var L = D > M ? g.slice(0, M - p) : g;
                t.addToken(t, L, a ? a + l : l, u, p + L.length == v ? c : "", s, f);
              }
      ...
      function rn(e, t, n) {
        this.line = t, this.rest = function (e) {
          ...
          return n;
        }(t), this.size = this.rest ? Xe(q(this.rest)) - n + 1 : 1, this.node = this.text = null, this.hidden = $t(e, t);
      }
      ...
      function mn(e, t, n, r) {
        ...
        if (e.options.lineNumbers || o) {
          ...
          if (e.display.input.setUneditable(s), a.insertBefore(s, t.text), t.line.gutterClass && (s.className += " " + t.line.gutterClass), !e.options.lineNumbers || o && o["CodeMirror-linenumbers"] || (t.lineNumber = s.appendChild(T("div", Ze(e.options, n), "CodeMirror-linenumber CodeMirror-gutter-elt", "left: " + r.gutterLeft["CodeMirror-linenumbers"] + "px; width: " + e.display.lineNumInnerWidth + "px"))), o) for (var l = 0; l < e.display.gutterSpecs.length; ++l) {
            var c = e.display.gutterSpecs[l].className,
                u = o.hasOwnProperty(c) && o[c];
            u && s.appendChild(T("div", [u], "CodeMirror-gutter-elt", "left: " + r.gutterLeft[c] + "px; width: " + r.gutterWidth[c] + "px"));
          }
        }
      }
      ...
      function bn(e, t, n, r, i) {
        if (t.widgets) for (var o = dn(n), a = 0, s = t.widgets; a < s.length; ++a) {
          var l = s[a],
              c = T("div", [l.node], "CodeMirror-linewidget" + (l.className ? " " + l.className : ""));
      ...
      function Tn(e, t, n) {
        ...
        for (var i = 0; i < e.rest.length; i++) if (Xe(e.rest[i]) > n) return {
      ...
      function Un(e, t, n) {
        ...
        var r = t.left,
            i = t.top;
        if ("page" == n) r -= $n(), i -= Hn();else if ("local" == n || !n) {
      ...
      function tr(e, t, n, r, i, o, a) {
        var s = oe(function (s) {
          var l = i[s],
              c = 1 != l.level;
          return Zn(Kn(e, et(n, c ? l.to : l.from, c ? "before" : "after"), "line", t, r), o, a, !0);
        }, 0, i.length - 1),
            l = i[s];

        if (s > 0) {
          var c = 1 != l.level,
              u = Kn(e, et(n, c ? l.from : l.to, c ? "after" : "before"), "line", t, r);
      ...
      function rr(e) {
        ...
        if (null == Nn) {
          Nn = T("pre", null, "CodeMirror-line-like");
      ...
      function cr(e, t, n, r) {
        ...
        if (r && c.xRel > 0 && (l = Ge(e.doc, c.line).text).length == c.ch) {
          var u = W(l, l.length, e.options.tabSize) - l.length;
      ...
      function dr(e, t, n, r) {
        ...
        var i = e.display;
        if (r && n < i.viewTo && (null == i.updateLineNumbers || i.updateLineNumbers > t) && (i.updateLineNumbers = t), e.curOp.viewChanged = !0, t >= i.viewTo) kt && zt(e.doc, t) < i.viewTo && hr(e);else if (n <= i.viewFrom) kt && Pt(e.doc, n + r) > i.viewFrom ? hr(e) : (i.viewFrom += r, i.viewTo += r);else if (t <= i.viewFrom && n >= i.viewTo) hr(e);else if (t <= i.viewFrom) {
          var o = pr(e, n, n + r, 1);
      ...
      function pr(e, t, n, r) {
        var i,
            o = ur(e, t),
            a = e.display.view;
        if (!kt || n == e.doc.first + e.doc.size) return {
          index: o,
          lineN: n
        };
      ...
      function xr(e, t, n) {
        var r = e.display,
            ...
            a = An(e.display),
            s = a.left,
            l = Math.max(r.sizerWidth, Dn(e) - r.sizer.offsetLeft) - a.right,
            c = "ltr" == i.direction;
        ...
        function d(t, n, r) {
          ...
          return function (e, t, n, r) {
            ...
            if (y.top - v.top <= 3) {
              ...
              var M, D, L, T;
              g ? (M = c && b && w ? s : v.left, D = c ? l : p(e, i, "before"), L = c ? s : p(t, i, "after"), T = c && x && k ? l : y.right) : (M = c ? p(e, i, "before") : s, D = !c && b && w ? l : v.right, L = !c && x && k ? s : y.left, T = c ? p(t, i, "after") : l), u(M, v.top, D - M, v.bottom), v.bottom < y.top && u(s, v.bottom, null, y.top), u(L, y.top, T - L, y.bottom);
            }
      ...
      function Sr(e, t) {
        e.state.delayingBlurEvent && (e.state.delayingBlurEvent = !1), "nocursor" != e.options.readOnly && (e.state.focused || (pe(e, "focus", e, t), e.state.focused = !0, _(e.display.wrapper, "CodeMirror-focused"), e.curOp || e.display.selForContextMenu == e.doc.sel || (e.display.input.reset(), l && setTimeout(function () {
          return e.display.input.reset(!0);
        }, 20)), e.display.input.receivedFocus()), wr(e));
      }

      function Ar(e, t) {
        e.state.delayingBlurEvent || (e.state.focused && (pe(e, "blur", e, t), e.state.focused = !1, M(e.display.wrapper, "CodeMirror-focused")), clearInterval(e.display.blinker), setTimeout(function () {
      ...
      function Mr(e) {
        for (var t = e.display, n = t.lineDiv.offsetTop, r = 0; r < t.view.length; r++) {
          ...
          if (!i.hidden) {
            ...
            if ((f > .005 || f < -.005) && (Ye(i.line, l), Dr(i.line), i.rest)) for (var h = 0; h < i.rest.length; h++) Dr(i.rest[h]);
      ...
      function Tr(e, t) {
        ...
        var d = e.curOp && null != e.curOp.scrollLeft ? e.curOp.scrollLeft : n.scroller.scrollLeft,
            f = Dn(e) - (e.options.fixedGutter ? n.gutters.offsetWidth : 0),
            h = t.right - t.left > f;
      ...
      function _r(e) {
        ...
        t && (e.curOp.scrollToPos = null, Nr(e, qn(e, t.from), qn(e, t.to), t.margin));
      }
      ...
      function $r(e, t) {
        ...
        for (var i = 0; i < 4 && n != e.display.barWidth || r != e.display.barHeight; i++) n != e.display.barWidth && e.options.lineWrapping && Mr(e), Hr(e, Wr(e)), n = e.display.barWidth, r = e.display.barHeight;
      }
      ...
      function Vr(e) {
        e.display.scrollbars && (e.display.scrollbars.clear(), e.display.scrollbars.addClass && M(e.display.wrapper, e.display.scrollbars.addClass)), e.display.scrollbars = new Br[e.options.scrollbarStyle](function (t) {
        ...
        }, e), e.display.scrollbars.addClass && _(e.display.wrapper, e.display.scrollbars.addClass);
      }
      ...
      function qr(e) {
        ...
        }(t), e.updateMaxLine && Ut(t), e.mustUpdate = e.viewChanged || e.forceUpdate || null != e.scrollTop || e.scrollToPos && (e.scrollToPos.from.line < n.viewFrom || e.scrollToPos.to.line >= n.viewTo) || n.maxLineChanged && t.options.lineWrapping, e.update = e.mustUpdate && new oi(t, e.mustUpdate && {
          top: e.scrollTop,
      ...
      function Jr(e) {
        ...
        e.preparedSelection && t.display.input.showSelection(e.preparedSelection, n), (e.updatedDisplay || e.startHeight != t.doc.height) && $r(t, e.barMeasure), e.updatedDisplay && ui(t, e.barMeasure), e.selectionChanged && wr(t), t.state.focused && e.updateInput && t.display.input.reset(e.typing), n && kr(e.cm);
      }
      ...
      function Qr(e) {
        var t = e.cm,
            n = t.display,
            r = t.doc;
        e.updatedDisplay && si(t, e.update), null == n.wheelStartX || null == e.scrollTop && null == e.scrollLeft && !e.scrollToPos || (n.wheelStartX = n.wheelStartY = null), null != e.scrollTop && Fr(t, e.scrollTop, e.forceScroll), null != e.scrollLeft && Rr(t, e.scrollLeft, !0, !0), e.scrollToPos && function (e, t) {
          ...
          for (var o = 0; o < 5; o++) {
            var a = !1,
              ...
              bottom: Math.max(s.bottom, l.bottom) + r
                ...
                u = e.doc.scrollTop,
                d = e.doc.scrollLeft;
            if (null != c.scrollTop && (Ir(e, c.scrollTop), Math.abs(e.doc.scrollTop - u) > 1 && (a = !0)), null != c.scrollLeft && (Rr(e, c.scrollLeft), Math.abs(e.doc.scrollLeft - d) > 1 && (a = !0)), !a) break;
          }
      ...
      function ii(e) {
        ...
        if (!(t.highlightFrontier >= e.display.viewTo)) {
          ...
          }), t.highlightFrontier = r.line, t.modeFrontier = Math.max(t.modeFrontier, r.line), i.length && Zr(e, function () {
      ...
      var oi = function (e, t, n) {
        var r = e.display;
        this.viewport = t, this.visible = Lr(r, e.doc, t), this.editorIsHidden = !r.wrapper.offsetWidth, this.wrapperHeight = r.wrapper.clientHeight, this.wrapperWidth = r.wrapper.clientWidth, this.oldDisplayWidth = Dn(e), this.force = n, this.dims = or(e), this.events = [];
      };
      ...
      function ai(e, t) {
        ...
        n.viewFrom < o && o - n.viewFrom < 20 && (o = Math.max(r.first, n.viewFrom)), n.viewTo > a && n.viewTo - a < 20 && (a = Math.min(i, n.viewTo)), kt && (o = zt(e.doc, o), a = Pt(e.doc, a));
        ...
        }(e, o, a), n.viewOffset = Bt(Ge(e.doc, n.viewFrom)), e.display.mover.style.top = n.viewOffset + "px";
        var c = mr(e);
        ...
        return c > 4 && (n.lineDiv.style.display = "none"), function (e, t, n) {
          ...
          for (var c = r.view, u = r.viewFrom, d = 0; d < c.length; d++) {
            ...
            if (f.hidden) ;else if (f.node && f.node.parentNode == o) {
              ...
              f.changes && (P(f.changes, "gutter") > -1 && (h = !1), un(e, f, u, n)), h && (D(f.lineNumber), f.lineNumber.appendChild(document.createTextNode(Ze(e.options, u)))), a = f.node.nextSibling;
            } else {
              var p = vn(e, f, u, n);
              o.insertBefore(p, a);
            }
        ...
        }(u), D(n.cursorDiv), D(n.selectionDiv), n.gutters.style.height = n.sizer.style.minHeight = 0, s && (n.lastWrapHeight = t.wrapperHeight, n.lastWrapWidth = t.wrapperWidth, ri(e, 400)), n.updateLineNumbers = null, !0;
      }

      function si(e, t) {
        for (var n = t.viewport, r = !0;; r = !1) {
          if (r && e.options.lineWrapping && t.oldDisplayWidth != Dn(e)) r && (t.visible = Lr(e.display, e.doc, n));else if (n && null != n.top && (n = {
      ...
      function di(e) {
        ...
        if (t.alignWidgets || t.gutters.firstChild && e.options.fixedGutter) {
          for (var r = ar(t) - t.scroller.scrollLeft + e.doc.scrollLeft, i = t.gutters.offsetWidth, o = r + "px", a = 0; a < n.length; a++) if (!n[a].hidden) {
      ...
      function wi(e, t) {
        ...
        if (i && c || o && u) {
          if (o && y && l) e: for (var f = t.target, h = a.view; f != s; f = f.parentNode) for (var p = 0; p < h.length; p++) if (h[p].node == f) {
      ...
      a ? yi = -.53 : n ? yi = 15 : u ? yi = -.7 : f && (yi = -1 / 3);
      ...
      function Li(e, t) {
        for (var n = [], r = 0; r < e.sel.ranges.length; r++) {
          ...
          n.push(new Ci(Di(i.anchor, t), Di(i.head, t)));
        }
      ...
      function Oi(e) {
        e.doc.mode = ze(e.options, e.doc.modeOption), ji(e);
      }
      ...
      function _i(e, t, n, r) {
        ...
        var s = t.from,
            ...
            h = i(c.length - 1),
            p = l.line - s.line;
        if (t.full) e.insert(0, a(0, c.length)), e.remove(c.length, e.size - c.length);else if (Ei(e, t)) {
          var m = a(0, c.length - 1);
          o(d, d.text, h), p && e.remove(s.line, p), m.length && e.insert(s.line, m);
        } else if (u == d) {
          if (1 == c.length) o(u, u.text.slice(0, s.ch) + f + u.text.slice(l.ch), h);else {
      ...
      function Pi(e, t, n, r) {
        ...
        if ((i.lastOp == r || i.lastOrigin == t.origin && t.origin && ("+" == t.origin.charAt(0) && i.lastModTime > s - (e.cm ? e.cm.options.historyEventDelay : 500) || "*" == t.origin.charAt(0))) && (o = function (e, t) {
          return t ? (zi(e.done), q(e.done)) : e.done.length && !q(e.done).ranges ? q(e.done) : e.done.length > 1 && !e.done[e.done.length - 2].ranges ? (e.done.pop(), q(e.done)) : void 0;
        }(i, i.lastOp == r))) a = q(o.changes), 0 == tt(t.from, t.to) && 0 == tt(t.from, a.to) ? a.to = Mi(t) : o.changes.push(Wi(e, t));else {
          var l = q(i.done);
      ...
      function $i(e, t, n, r) {
        ...
        }(e, o, q(i.done), t)) ? i.done[i.done.length - 1] = t : Hi(t, i.done), i.lastSelTime = +new Date(), i.lastSelOrigin = o, i.lastSelOp = n, r && !1 !== r.clearRedo && zi(i.undone);
      }
          ...
          if (o.ranges) r.push(n ? ki.prototype.deepCopy.call(o) : o);else {
            ...
            for (var l = 0; l < a.length; ++l) {
              ...
              if (s.push({
                ...
                to: c.to,
                text: c.text
              }), t) for (var d in c) (u = d.match(/^spans_(\d+)$/)) && P(t, Number(u[1])) > -1 && (q(s)[d] = c[d], delete c[d]);
            }
          }
        }
      ...
      function qi(e, t, n, r, i) {
        null == i && (i = e.cm && (e.cm.display.shift || e.extend)), Zi(e, new ki([Ki(e.sel.primary(), t, n, i)], 0), r);
      }
      ...
      function Zi(e, t, n) {
        eo(e, t, n), $i(e, e.sel, e.cm ? e.cm.curOp.id : NaN, n);
      }
      ...
      function eo(e, t, n) {
        ...
        to(e, ro(e, t, r, !0)), n && !1 === n.scroll || !e.cm || jr(e.cm);
      }
      ...
      function uo(e, t) {
        if (1 != t.text.length || "" != t.text[0] || 0 != tt(t.from, t.to)) {
          var n = Li(e, t);
          Pi(e, t, n, e.cm ? e.cm.curOp.id : NaN), po(e, t, n, Mt(e, t));
          var r = [];
          Ni(e, function (e, n) {
            n || -1 != P(r, e.history) || (yo(e.history, t), r.push(e.history)), po(e, t, null, Mt(e, t));
          });
        }
      }
        ...
        if (!r || n) {
          ...
          if (c != s.length) {
            for (o.lastOrigin = o.lastSelOrigin = null;;) {
              ...
              if (Hi(i, l), n && !i.equals(e.sel)) return void Zi(e, i, {
                clearRedo: !1
              });
              a = i;
            }
            ...
            for (var d = ve(e, "beforeChange") || e.cm && ve(e.cm, "beforeChange"), f = function (n) {
              var r = i.changes[n];
              if (r.origin = t, d && !lo(e, r, !1)) return s.length = 0, {};
              u.push(Wi(e, r));
              var o = n ? Li(e, r) : q(s);
              po(e, r, o, Ui(e, r)), !n && e.cm && e.cm.scrollIntoView({
                from: r.from,
                to: Mi(r)
              });
              var a = [];
              Ni(e, function (e, t) {
                t || -1 != P(a, e.history) || (yo(e.history, r), a.push(e.history)), po(e, r, null, Ui(e, r));
              });
      ...
      function po(e, t, n, r) {
        ...
        if (t.to.line < e.first) ho(e, t.text.length - 1 - (t.to.line - t.from.line));else if (!(t.from.line > e.lastLine())) {
          ...
          t.to.line > o && (t = {
            ...
            text: [t.text[0]],
            origin: t.origin
          }), t.removed = Ke(e, t.from, t.to), n || (n = Li(e, t)), e.cm ? function (e, t, n) {
            var r = e.doc,
                i = e.display,
                o = t.from,
                a = t.to,
                s = !1,
                l = o.line;
            e.options.lineWrapping || (l = Xe(Wt(Ge(r, o.line))), r.iter(l, a.line + 1, function (e) {
              if (e == i.maxLine) return s = !0, !0;
            })), r.sel.contains(t.from, t.to) > -1 && ge(e), _i(r, t, n, sr(e)), e.options.lineWrapping || (r.iter(l, o.line + t.text.length, function (e) {
              var t = Vt(e);
          ...
          }(e.cm, t, r) : _i(e, t, r), eo(e, n, H), e.cantEdit && oo(e, et(e.firstLine(), 0)) && (e.cantEdit = !1);
        }
      }
      ...
      Ci.prototype.from = function () {
        ...
        removeInner: function (e, t) {
          for (var n = e, r = e + t; n < r; ++n) {
            var i = this.lines[n];
            this.height -= i.height, Kt(i), ln(i, "delete");
          }
      ...
      ko.prototype.clear = function () {
        ...
        if (null != r && t) {
          ...
          var o = wn(this);
          Ye(n, Math.max(0, n.height - o)), e && (Zr(e, function () {
        ...
        this.height = null;
        var i = wn(this) - t;
        i && ($t(this.doc, r) || Ye(r, r.height + i), n && Zr(n, function () {
      ...
      function Mo(e, t, n, r, i) {
        ...
        if (e.iter(l, n.line + 1, function (e) {
          c && o.collapsed && !c.options.lineWrapping && Wt(e) == c.display.maxLine && (s = !0), o.collapsed && l != t.line && Ye(e, 0), function (e, t) {
            e.markedSpans = e.markedSpans ? e.markedSpans.concat([t]) : [t], t.marker.attachLine(e);
          }(e, new Ct(o, l == t.line ? t.ch : null, l == n.line ? n.ch : null)), ++l;
          ...
          if (s && (c.curOp.updateMaxLine = !0), o.collapsed) dr(c, t.line, n.line + 1);else if (o.className || o.startStyle || o.endStyle || o.css || o.attributes || o.title) for (var u = t.line; u <= n.line; u++) fr(c, u, "text");
      ...
      Ao.prototype.clear = function () {
        if (!this.explicitlyCleared) {
          ...
          for (var r = null, i = null, o = 0; o < this.lines.length; ++o) {
            ...
            e && !this.collapsed ? fr(e, Xe(a), "text") : e && (null != s.to && (i = Xe(a)), null != s.from && (r = Xe(a))), a.markedSpans = At(a.markedSpans, s), null == s.from && this.collapsed && !$t(this.doc, a) && e && Ye(a, rr(e.display));
          }

          if (e && this.collapsed && !e.options.lineWrapping) for (var l = 0; l < this.lines.length; ++l) {
            var c = Wt(this.lines[l]),
                u = Vt(c);
        ...
        t && r && Zr(r, function () {
          ...
          if (a && (Wn(a), r.curOp.selectionChanged = r.curOp.forceUpdate = !0), r.curOp.updateMaxLine = !0, !$t(n.doc, i) && null != n.height) {
            var s = n.height;
            n.height = null;
            var l = wn(n) - s;
            l && Ye(i, i.height + l);
      ...
      var Oo = 0,
        ...
        var o = et(n, 0);
        this.sel = Ai(o), this.history = new Ri(null), this.id = ++Oo, this.modeOption = t, this.lineSep = r, this.direction = "rtl" == i ? "rtl" : "ltr", this.extend = !1, "string" == typeof e && (e = this.splitLines(e)), _i(this, {
          from: o,
          to: o,
          text: e
        }), Zi(this, Ai(o), H);
      ...
      jo.prototype = J(wo.prototype, {
        ...
        setValue: ni(function (e) {
          ...
          co(this, {
            ...
            origin: "setValue",
            full: !0
          }, !0), this.cm && Er(this.cm, 0, 0), Zi(this, Ai(t), H);
        }),
        replaceRange: function (e, t, n, r) {
          mo(this, e, t = st(this, t), n = n ? st(this, n) : t, r);
        },
        getRange: function (e, t, n) {
          var r = Ke(this, st(this, e), st(this, t));
        ...
        getLineHandleVisualStart: function (e) {
          return "number" == typeof e && (e = Ge(this, e)), Wt(e);
        },
        lineCount: function () {
          return this.size;
        },
        ...
        extendSelection: ni(function (e, t, n) {
          qi(this, st(this, e), t && st(this, t), n);
        }),
        ...
        setSelections: ni(function (e, t, n) {
          if (e.length) {
            for (var r = [], i = 0; i < e.length; i++) r[i] = new Ci(st(this, e[i].anchor), st(this, e[i].head));
        ...
        clearHistory: function () {
          var e = this;
          this.history = new Ri(this.history.maxGeneration), Ni(this, function (t) {
        ...
        addLineWidget: ni(function (e, t, n) {
          return function (e, t, n, r) {
            ...
            return o && i.noHScroll && (o.display.alignWidgets = !0), bo(e, t, "widget", function (t) {
              ...
              if (null == i.insertAt ? n.push(i) : n.splice(Math.min(n.length - 1, Math.max(0, i.insertAt)), 0, i), i.line = t, o && !$t(e, t)) {
                var r = Bt(t) < e.scrollTop;
                Ye(t, t.height + wn(i)), r && Or(o, i.height), o.curOp.forceUpdate = !0;
              }

              return !0;
            }), o && ln(o, "lineWidgetAdded", o, i, "number" == typeof t ? t : Xe(t)), i;
          }(this, e, t, n);
        }),
        ...
        copy: function (e) {
          var t = new jo(qe(this, this.first, this.first + this.size), this.modeOption, this.first, this.lineSep, this.direction);
        ...
        unlinkDoc: function (e) {
          if (e instanceof Da && (e = e.doc), this.linked) for (var t = 0; t < this.linked.length; ++t) if (this.linked[t].doc == e) {
      ...
      function _o(e) {
        ...
        if (No(t), !me(t, e) && !kn(t.display, e)) {
          ...
          if (n && !t.isReadOnly()) if (r && r.length && window.FileReader && window.File) for (var i = r.length, o = Array(i), s = 0, l = function () {
            ++s == i && ei(t, function () {
              var e = {
                from: n = st(t.doc, n),
                to: n,
            ...
            if (t.options.allowDropFileTypes && -1 == P(t.options.allowDropFileTypes, e.type)) l();else {
      ...
      for (var zo = {
        ...
        63277: "PageDown",
        63302: "Insert"
      }, Po = 0; Po < 10; Po++) zo[Po + 48] = zo[Po + 96] = String(Po);

      for (var $o = 65; $o <= 90; $o++) zo[$o] = String.fromCharCode($o);
      ...
      function ia(e, t, n) {
        ...
        try {
          e.isReadOnly() && (e.state.suppressEdits = !0), n && (e.display.shift = !1), i = t(e) != $;
        } finally {
      ...
      function ua(e) {
        ...
        if (!(e.target && e.target != t.display.input.getField() || (t.curOp.focus = E(), me(t, e)))) {
          ...
          var i = la(t, e);
          d && (ca = i ? r : null, i || 88 != r || _e || !(y ? e.metaKey : e.ctrlKey) || t.replaceSelection("", null, "cut")), n && !y && !i && 46 == r && e.shiftKey && !e.ctrlKey && document.execCommand && document.execCommand("cut"), 18 != r || /\bCodeMirror-crosshair\b/.test(t.display.lineDiv.className) || function (e) {
      ...
      function ga(e) {
        var t = this,
            n = t.display;
        if (!(me(t, e) || n.activeTouch && n.input.supportsTouch())) if (n.input.ensurePolled(), n.shift = e.shiftKey, kn(n, e)) l || (n.scroller.draggable = !1, setTimeout(function () {
          ...
          window.focus(), 1 == i && t.state.selectingText && t.state.selectingText(e), r && function (e, t, n, r, i) {
            var o = "Click";
            return "double" == r ? o = "Double" + o : "triple" == r && (o = "Triple" + o), aa(e, qo(o = (1 == t ? "Left" : 2 == t ? "Middle" : "Right") + o, i), i, function (t) {
            ...
            e.options.dragDrop && De && !e.isReadOnly() && "single" == n && (i = c.contains(t)) > -1 && (tt((i = c.ranges[i]).from(), t) < 0 || t.xRel > 0) && (tt(i.to(), t) > 0 || t.xRel < 0) ? function (e, t, n, r) {
              var i = e.display,
                  o = !1,
                  c = ei(e, function (t) {
                l && (i.scroller.draggable = !1), e.state.draggingText = !1, he(i.wrapper.ownerDocument, "mouseup", c), he(i.wrapper.ownerDocument, "mousemove", u), he(i.scroller, "dragstart", d), he(i.scroller, "drop", c), o || (be(t), r.addNew || qi(e.doc, n, null, null, r.extend), l && !f || a && 9 == s ? setTimeout(function () {
              ...
              l && (i.scroller.draggable = !0), e.state.draggingText = c, c.copy = !r.moveOnDrag, i.scroller.dragDrop && i.scroller.dragDrop(), de(i.wrapper.ownerDocument, "mouseup", c), de(i.wrapper.ownerDocument, "mousemove", u), de(i.scroller, "dragstart", d), de(i.scroller, "drop", c), Cr(e), setTimeout(function () {
              ...
              var a,
                  ...
                  l = o.sel,
                  c = l.ranges;
              if (r.addNew && !r.extend ? (s = o.sel.contains(n), a = s > -1 ? c[s] : new Ci(n, n)) : (a = o.sel.primary(), s = o.sel.primIndex), "rectangle" == r.unit) r.addNew || (a = new Ci(n, n)), n = cr(e, t, !0, !0), s = -1;else {
                var u = va(e, n, r.unit);
                a = r.extend ? Ki(a, u.anchor, u.head, r.extend) : u;
              }
              r.addNew ? -1 == s ? (s = c.length, Zi(o, Si(e, c.concat([a]), s), {
                scroll: !1,
                origin: "*mouse"
              })) : c.length > 1 && c[s].empty() && "char" == r.unit && !r.extend ? (Zi(o, Si(e, c.slice(0, s).concat(c.slice(s + 1)), 0), {
                scroll: !1,
                origin: "*mouse"
              }), l = o.sel) : Xi(o, s, a, B) : (s = 0, Zi(o, new ki([a], 0), B), l = o.sel);
              var d = n;

              function f(t) {
                if (0 != tt(d, t)) if (d = t, "rectangle" == r.unit) {
                  for (var i = [], c = e.options.tabSize, u = W(Ge(o, n.line).text, n.ch, c), f = W(Ge(o, t.line).text, t.ch, c), h = Math.min(u, f), p = Math.max(u, f), m = Math.min(n.line, t.line), g = Math.min(e.lastLine(), Math.max(n.line, t.line)); m <= g; m++) {
                    var v = Ge(o, m).text,
                        y = U(v, h, c);
                    h == p ? i.push(new Ci(et(m, y), et(m, y))) : v.length > y && i.push(new Ci(et(m, y), et(m, U(v, p, c))));
                  }

                  i.length || i.push(new Ci(n, n)), Zi(o, Si(e, l.ranges.slice(0, s).concat(i), s), {
                    origin: "*mouse",
                    scroll: !1
                  }), e.scrollIntoView(t);
                } else {
                  ...
                  }(e, new Ci(st(o, k), b)), Zi(o, Si(e, C, s), B);
                }
              }
              ...
              function m(t) {
                e.state.selectingText = !1, p = 1 / 0, t && (be(t), i.input.focus()), he(i.wrapper.ownerDocument, "mousemove", g), he(i.wrapper.ownerDocument, "mouseup", v), o.history.lastSelOrigin = null;
              }
          ...
          }(t, r, o, e) : Ce(e) == n.scroller && be(e) : 2 == i ? (r && qi(t.doc, r), setTimeout(function () {
      ...
      function Ma(e) {
        e.options.lineWrapping ? (_(e.display.wrapper, "CodeMirror-wrap"), e.display.sizer.style.minWidth = "", e.display.sizerWidth = null) : (M(e.display.wrapper, "CodeMirror-wrap"), Ut(e)), lr(e), dr(e), Pn(e), setTimeout(function () {
          return $r(e);
        }, 100);
      }
      ...
      function Da(e, t) {
        ...
        for (var c in o.wrapper.CodeMirror = this, wa(this), t.lineWrapping && (this.display.wrapper.className += " CodeMirror-wrap"), Vr(this), this.state = {
          keyMaps: [],
          overlays: [],
          modeGen: 0,
          overwrite: !1,
          ...
          var t = e.display;
          de(t.scroller, "mousedown", ei(e, ga)), de(t.scroller, "dblclick", a && s < 11 ? ei(e, function (t) {
            if (!me(e, t)) {
              var n = cr(e, t);
          ...
          de(t.scroller, "touchstart", function (i) {
            ...
            if (r && !kn(t, n) && null != r.left && !r.moved && new Date() - r.start < 300) {
              ...
              a = !r.prev || o(r, r.prev) ? new Ci(s, s) : !r.prev.prev || o(r, r.prev.prev) ? e.findWordAt(s) : new Ci(et(s.line, 0), st(e.doc, et(s.line + 1, 0))), e.setSelection(a.anchor, a.head), e.focus(), be(n);
            }
            ...
            over: function (t) {
              me(e, t) || (function (e, t) {
                ...
                if (n) {
                  ...
                  yr(e, n, r), e.display.dragCursor || (e.display.dragCursor = T("div", null, "CodeMirror-cursors CodeMirror-dragcursors"), e.display.lineSpace.insertBefore(e.display.dragCursor, e.display.cursorDiv)), L(e.display.dragCursor, r);
                }
              }(e, t), ke(t));
            },
            start: function (t) {
              return function (e, t) {
                if (a && (!e.state.draggingText || +new Date() - Eo < 100)) ke(t);else if (!me(e, t) && !kn(e.display, t) && (t.dataTransfer.setData("Text", e.getSelection()), t.dataTransfer.effectAllowed = "copyMove", t.dataTransfer.setDragImage && !f)) {
          ...
          de(l, "keyup", function (t) {
            return da.call(e, t);
          }), de(l, "keydown", ei(e, ua)), de(l, "keypress", ei(e, fa)), de(l, "focus", function (t) {
            return Sr(e, t);
          }), de(l, "blur", function (t) {
            return Ar(e, t);
          });
        }(this), Ro(), Gr(this), this.curOp.forceUpdate = !0, Ii(this, r), t.autofocus && !v || this.hasFocus() ? setTimeout(F(Sr, this), 20) : Ar(this), Sa) Sa.hasOwnProperty(c) && Sa[c](this, t[c], ka);

        fi(this), t.finishInit && t.finishInit(this);

        for (var u = 0; u < La.length; ++u) La[u](this);

        Kr(this), l && t.lineWrapping && "optimizelegibility" == getComputedStyle(o.lineDiv).textRendering && (o.lineDiv.style.textRendering = "auto");
      }

      Da.defaults = Ca, Da.optionHandlers = Sa;
      var La = [];
      ...
      function Ta(e, t, n, r) {
        ...
        "prev" == n ? c = t > o.first ? W(Ge(o, t - 1).text, null, a) : 0 : "add" == n ? c = l + e.options.indentUnit : "subtract" == n ? c = l - e.options.indentUnit : "number" == typeof n && (c = l + n), c = Math.max(0, c);
        var d = "",
            f = 0;
        if (e.options.indentWithTabs) for (var h = Math.floor(c / a); h; --h) f += a, d += "\t";
        if (f < c && (d += K(c - f)), d != u) return mo(o, d, et(t, 0), et(t, u.length), "+input"), s.stateAfter = null, !0;
      ...
      function Ea(e, t, n, r, i) {
        ...
        var a = +new Date() - 200,
            ...
            l = je(t),
            c = null;
        if (s && r.ranges.length > 1) if (Oa && Oa.text.join("\n") == t) {
        ...
        for (var d = e.curOp.updateInput, f = r.ranges.length - 1; f >= 0; f--) {
          var h = r.ranges[f],
              p = h.from(),
              m = h.to();
          h.empty() && (n && n > 0 ? p = et(p.line, p.ch - n) : e.state.overwrite && !s ? m = et(m.line, Math.min(Ge(o, m.line).text.length, m.ch + q(l).length)) : s && Oa && Oa.lineWise && Oa.text.join("\n") == l.join("\n") && (p = m = et(p.line, 0)));
          var g = {
            from: p,
            to: m,
      ...
      function _a(e, t) {
        ...
        if (n) return e.preventDefault(), t.isReadOnly() || t.options.disableInput || Zr(t, function () {
      ...
      function Wa(e, t, n, r, i) {
        ...
        function c(r) {
          ...
          if (null == (o = i ? function (e, t, n, r) {
            ...
            if (r || (a = t.line + l) < e.first || a >= e.first + e.size || (t = new et(a, t.ch, t.sticky), !(s = Ge(e, a)))) return !1;
        ...
        if ("char" == r) c();else if ("column" == r) c(!0);else if ("word" == r || "group" == r) for (var u = null, d = "group" == r, f = e.cm && e.cm.getHelper(t, "wordChars"), h = !0; !(n < 0) || c(!h); h = !1) {
      ...
      Pa.prototype.init = function (e) {
        ...
        Fa(i, r.options.spellcheck, r.options.autocorrect, r.options.autocapitalize), de(i, "paste", function (e) {
          !o(e) || me(r, e) || _a(e, r) || s <= 11 && setTimeout(ei(r, function () {
      ...
      }, Pa.prototype.screenReaderLabelChanged = function (e) {
        ...
        for (var d = r.doc.splitLines(function (e, t, n, r, i) {
          ...
          function d(t) {
            if (1 == t.nodeType) {
              ...
              if (f) {
                var h = e.findMarks(et(r, 0), et(i + 1, 0), (g = +f, function (e) {
                  return e.id == g;
                }));
                return void (h.length && (o = h[0].find(0)) && u(Ke(e.doc, o.from, o.to).join(s)));
              }
          ...
          return o;
        }(r, n, c, t, l)), f = Ke(r.doc, et(t, 0), et(l, Ge(r.doc, l).text.length)); d.length > 1 && f.length > 1;) if (q(d) == q(f)) d.pop(), f.pop(), l--;else {
          if (d[0] != f[0]) break;
          d.shift(), f.shift(), t++;
        }
        ...
        for (var y = q(d), b = q(f), x = Math.min(y.length - (1 == d.length ? h : 0), b.length - (1 == f.length ? h : 0)); p < x && y.charCodeAt(y.length - p - 1) == b.charCodeAt(b.length - p - 1);) ++p;
        ...
        var w = et(t, h),
            k = et(l, f.length ? q(f).length - p : 0);
      ...
      }, Pa.prototype.onContextMenu = function () {}, Pa.prototype.resetPosition = function () {}, Pa.prototype.needsContentAttribute = !0;
      ...
      Ua.prototype.init = function (e) {
          ...
          if (!me(r, e)) {
            if (r.somethingSelected()) ja({
              ...
              ja({
                lineWise: !0,
                text: t.text
              }), "cut" == e.type ? r.setSelections(t.ranges, null, H) : (n.prevInput = "", i.value = t.text.join("\n"), I(i));
            }
        ...
        if (o && !d) {
          ...
          if (t.wrapper.style.cssText = "position: static", i.style.cssText = "position: absolute; width: 30px; height: 30px;\n      top: " + (e.clientY - p.top - 5) + "px; left: " + (e.clientX - p.left - 5) + "px;\n      z-index: 1000; background: " + (a ? "rgba(255, 255, 255, .05)" : "transparent") + ";\n      outline: none; border-width: 0; outline: none; overflow: hidden; opacity: .05; filter: alpha(opacity=5);", l && (u = window.scrollY), r.input.focus(), l && window.scrollTo(null, u), r.input.reset(), n.somethingSelected() || (i.value = t.prevInput = " "), t.contextMenuPending = v, r.selForContextMenu = n.doc.sel, clearTimeout(r.detectingSelectAll), a && s >= 9 && g(), C) {
            ke(e);
        ...
        function v() {
          if (t.contextMenuPending == v && (t.contextMenuPending = !1, t.wrapper.style.cssText = h, i.style.cssText = f, a && s < 9 && r.scrollbars.setScrollTop(r.scroller.scrollTop = c), null != i.selectionStart)) {
            (!a || a && s < 9) && g();
      ...
      }, Ua.prototype.setUneditable = function () {}, Ua.prototype.needsContentAttribute = !1, function (e) {
        ...
        e.defineOption = n, e.Init = ka, n("value", "", function (e, t) {
        ...
        }, !0), n("indentUnit", 2, Oi, !0), n("indentWithTabs", !1), n("smartIndent", !0), n("tabSize", 4, function (e) {
          ji(e), Pn(e), dr(e);
          ...
          Vr(e), $r(e), e.display.scrollbars.setScrollTop(e.doc.scrollTop), e.display.scrollbars.setScrollLeft(e.doc.scrollLeft);
        ...
        }, !0), n("dragDrop", !0, Aa), n("allowDropFileTypes", null), n("cursorBlinkRate", 530), n("cursorScrollMargin", 0), n("cursorHeight", 1, gr, !0), n("singleCursorHeightPerLine", !0, gr, !0), n("workTime", 100), n("workDelay", 100), n("flattenSpans", !0, ji, !0), n("addModeClass", !1, ji, !0), n("pollInterval", 100), n("undoDepth", 200, function (e, t) {
          return e.doc.history.undoDepth = t;
        }), n("historyEventDelay", 1250), n("viewportMargin", 10, function (e) {
          return e.refresh();
        }, !0), n("maxHighlightLength", 1e4, ji, !0), n("moveInputWithCursor", !0, function (e, t) {
        ...
        e.prototype = {
          ...
          indentSelection: ti(function (e) {
            for (var t = this.doc.sel.ranges, n = -1, r = 0; r < t.length; r++) {
              var i = t[r];
              if (i.empty()) i.head.line > n && (Ta(this, i.head.line, e, !0), n = i.head.line, r == this.doc.sel.primIndex && jr(this));else {
                var o = i.from(),
                    a = i.to(),
                    s = Math.max(n, o.line);
                n = Math.min(this.lastLine(), a.line - (a.ch ? 0 : 1)) + 1;

                for (var l = s; l < n; ++l) Ta(this, l, e);
          ...
          getHelpers: function (e, t) {
            ...
            for (var l = 0; l < i._global.length; l++) {
              var c = i._global[l];
              c.pred(o, this) && -1 == P(r, c.val) && r.push(c.val);
            }
          ...
          cursorCoords: function (e, t) {
            ...
            return Kn(this, null == e ? n.head : "object" == typeof e ? st(this.doc, e) : e ? n.from() : n.to(), t || "page");
          },
          ...
          heightAtLine: function (e, t, n) {
            ...
            return Vn(this, r, {
              top: 0,
              left: 0
            }, t || "page", n || i).top + (i ? this.doc.height - Bt(r) : 0);
          },
          ...
          addWidget: function (e, t, n, r, i) {
            var o,
                ...
                s,
                l = this.display,
                c = (e = Kn(this, st(this.doc, e))).bottom,
                u = e.left;
            ...
            t.style.top = c + "px", t.style.left = t.style.right = "", "right" == i ? (u = l.sizer.clientWidth - t.offsetWidth, t.style.right = "0px") : ("left" == i ? u = 0 : "middle" == i && (u = (l.sizer.clientWidth - t.offsetWidth) / 2), t.style.left = u + "px"), n && (o = this, a = {
              left: u,
              top: c,
              right: u + t.offsetWidth,
              bottom: c + t.offsetHeight
            }, null != (s = Tr(o, a)).scrollTop && Ir(o, s.scrollTop), null != s.scrollLeft && Rr(o, s.scrollLeft));
          },
          ...
          toggleOverwrite: function (e) {
            null != e && e == this.state.overwrite || ((this.state.overwrite = !this.state.overwrite) ? _(this.display.cursorDiv, "CodeMirror-overwrite") : M(this.display.cursorDiv, "CodeMirror-overwrite"), pe(this, "overwriteToggle", this, this.state.overwrite));
          },
          hasFocus: function () {
          ...
          refresh: ti(function () {
            ...
            dr(this), this.curOp.forceUpdate = !0, Pn(this), Er(this, this.doc.scrollLeft, this.doc.scrollTop), ci(this.display), (null == e || Math.abs(e - rr(this.display)) > .5 || this.options.lineWrapping) && lr(this), pe(this, "refresh", this);
          }),
          swapDoc: ti(function (e) {
            var t = this.doc;
            return t.cm = null, this.state.selectingText && this.state.selectingText(), Ii(this, e), Pn(this), this.display.input.reset(), Er(this, e.scrollLeft, e.scrollTop), this.curOp.forceScroll = !0, ln(this, "swapDoc", this, t), t;
          }),
          phrase: function (e) {
      ...
      for (var Ka in jo.prototype) jo.prototype.hasOwnProperty(Ka) && P(Ga, Ka) < 0 && (Da.prototype[Ka] = function (e) {
        return function () {
          return e.apply(this.doc, arguments);
        };
      }(jo.prototype[Ka]));

      return ye(jo), Da.inputStyles = {
        textarea: Ua,
        contenteditable: Pa
      }, Da.defineMode = function (e) {
        Da.defaults.mode || "null" == e || (Da.defaults.mode = e), Re.apply(this, arguments);
        ...
        t.finishInit = function (n) {
          n.save = r, n.getTextArea = function () {
            ...
            n.toTextArea = isNaN, r(), e.parentNode.removeChild(n.getWrapperElement()), e.style.display = "", e.form && (he(e.form, "submit", r), t.leaveSubmitMethodAlone || "function" != typeof e.form.submit || (e.form.submit = i));
          };
        ...
        e.off = he, e.on = de, e.wheelEventPixels = xi, e.Doc = jo, e.splitLines = je, e.countColumn = W, e.findColumn = U, e.isWordChar = Z, e.Pass = $, e.signal = pe, e.Line = Gt, e.changeEnd = Mi, e.scrollbarModel = Br, e.Pos = et, e.cmpPos = tt, e.modes = Ie, e.mimeModes = Fe, e.resolveMode = We, e.getMode = ze, e.modeExtensions = Pe, e.extendMode = $e, e.copyState = He, e.startState = Ve, e.innerMode = Be, e.commands = ta, e.keyMap = Bo, e.keyName = Yo, e.isModifierKey = Ko, e.lookupKey = Go, e.normalizeKeyMap = Uo, e.StringStream = Ue, e.SharedTextMarker = Do, e.TextMarker = Ao, e.LineWidget = ko, e.e_preventDefault = be, e.e_stopPropagation = xe, e.e_stop = ke, e.addClass = _, e.contains = j, e.rmClass = M, e.keyNames = zo;
      }(Da), Da.version = "5.56.0", Da;
    }();
  }, function (e, t, n) {
    var r = n(2).Symbol;
    e.exports = r;
    ...
    var r = function () {
      var e = this,
          t = e.$createElement,
          n = e._self._c || t;
      return n("div", [n("el-autocomplete", {
        staticClass: "certain-category-search",
        attrs: {
          "fetch-suggestions": e.querySearchAsync,
          placeholder: "mock",
          value: e.schema.mock ? e.schema.mock.mock : "",
          disabled: "object" === e.schema.type || "array" === e.schema.type
        },
        on: {
    ...
    var i = {
      ...
      methods: {
        ...
        o = n(1),
        a = Object(o.a)(i, r, [], !1, null, "ead96cb2", null);
    a.options.__file = "lib/json-schema-editor/src/MockSelect/index.vue";
    t.a = a.exports;
  }, function (e, t, n) {
    "use strict";
      ...
      return n("div", {
        ...
        return n("schema-item", {
          ...
          attrs: {
            ...
            "show-default-value": e.showDefaultValue,
    ...
    var i = {
      name: "SchemaObject",
      components: {
        "schema-item": () => n.e(1).then(n.bind(null, 159))
      },
      props: {
        prefix: {
          type: Array,
    ...
    var r = function () {
      ...
      return n("div", {
      ...
      }, ["object" === e.items.type ? n("span", {
        staticClass: "down-style",
        on: {
          click: e.handleClickIcon
        }
      }, [e.showIcon ? n("i", {
        staticClass: "el-icon-caret-right icon-object"
      }) : n("i", {
        staticClass: "el-icon-caret-bottom icon-object"
      })]) : e._e()]), n("el-col", {
        attrs: {
          span: 20
        }
        ...
        slot: "append"
      })])], 1) : e._e(), !e.showTitle && e.showDefaultValue ? n("el-col", {
        staticClass: "col-item col-item-mock",
        attrs: {
          span: e.isMock ? 4 : 5
        }
        ...
        model: {
          value: e.items.description,
          callback: function (t) {
            e.$set(e.items, "description", t);
          },
        ...
        staticClass: "el-icon-plus plus"
      })])], 1) : e._e()])], 1), n("div", {
        staticClass: "option-formStyle"
      }, ["array" === e.items.type ? [n("SchemaArray", {
        attrs: {
          prefix: e.prefixArray,
          data: e.items,
          "is-mock": e.isMock,
          "show-title": e.showTitle,
          "show-default-value": e.showDefaultValue,
      ...
      })] : e._e(), "object" !== e.items.type || e.showIcon ? e._e() : [n("SchemaObject", {
        attrs: {
          prefix: e.nameArray,
          data: e.items,
          "is-mock": e.isMock,
    ...
    var i = n(58),
      ...
      methods: {
        ...
        handleChangeType(e) {
          console.log(e), this.handleAction({
    ...
    !function (e) {
      ...
      e.defineMode("javascript", function (t, n) {
        ...
        function m(e, t) {
          ...
          if (f.test(r)) return ">" == r && t.lexical && ">" == t.lexical.type || (e.eat("=") ? "!" != r && "=" != r || e.eat("=") : /[<>*+\-]/.test(r) && (e.eat(r), ">" == r && e.eat(r))), "?" == r && e.eat(".") ? p(".") : p("operator", "operator", e.current());
        ...
        function y(e, t) {
          ...
          if (!(n < 0)) {
            ...
            for (var i = 0, o = !1, a = n - 1; a >= 0; --a) {
              ...
              } else if (l >= 3 && l < 6) ++i;else if (u.test(s)) o = !0;else if (/["'\/`]/.test(s)) for (;; --a) {
                if (0 == a) return;
        ...
        function M(e) {
          var t = k.state;
          if (k.marked = "def", t.context) if ("var" == t.lexical.info && t.context && t.context.block) {
            var r = function e(t, n) {
              if (n) {
                if (n.block) {
                  var r = e(t, n.prev);
                  return r ? r == n.prev ? n : new L(r, n.vars, !0) : null;
                }

                return A(t, n.vars) ? n : new L(n.prev, new T(t, n.vars), !1);
              }
          ...
          } else if (!A(e, t.localVars)) return void (t.localVars = new T(e, t.localVars));
          n.globalVars && !A(e, t.globalVars) && (t.globalVars = new T(e, t.globalVars));
        }
        ...
        var O = new T("this", new T("arguments", null));

        function j() {
          k.state.context = new L(k.state.context, k.state.localVars, !1), k.state.localVars = O;
        }

        function E() {
          k.state.context = new L(k.state.context, k.state.localVars, !0), k.state.localVars = null;
        }
        ...
        function R(e, t) {
          return "var" == e ? S(N("vardef", t), ye, F(";"), I) : "keyword a" == e ? S(N("form"), $, R, I) : "keyword b" == e ? S(N("form"), R, I) : "keyword d" == e ? k.stream.match(/^\s*$/, !1) ? S() : S(N("stat"), B, F(";"), I) : "debugger" == e ? S(F(";")) : "{" == e ? S(N("}"), E, oe, I, _) : ";" == e ? S() : "if" == e ? ("else" == k.state.lexical.info && k.state.cc[k.state.cc.length - 1] == I && k.state.cc.pop()(), S(N("form"), $, R, I, Se)) : "function" == e ? S(Le) : "for" == e ? S(N("form"), Ae, R, I) : "class" == e || c && "interface" == t ? (k.marked = "keyword", S(N("form", "class" == e ? e : t), _e, I)) : "variable" == e ? c && "declare" == t ? (k.marked = "keyword", S(R)) : c && ("module" == t || "enum" == t || "type" == t) && k.stream.match(/^\s*\w/, !1) ? (k.marked = "keyword", "enum" == t ? S(Ue) : "type" == t ? S(Oe, F("operator"), ue, F(";")) : S(N("form"), be, F("{"), N("}"), oe, I, I)) : c && "namespace" == t ? (k.marked = "keyword", S(N("form"), z, R, I)) : c && "abstract" == t ? (k.marked = "keyword", S(R)) : S(N("stat"), Q) : "switch" == e ? S(N("form"), $, F("{"), N("}", "switch"), E, oe, I, I, _) : "case" == e ? S(z, F(":")) : "default" == e ? S(F(":")) : "catch" == e ? S(N("form"), j, W, R, I, _) : "export" == e ? S(N("stat"), Re, I) : "import" == e ? S(N("stat"), ze, I) : "async" == e ? S(R) : "@" == t ? S(z, R) : C(N("stat"), z, F(";"), I);
        }
        ...
        function H(e, t, n) {
          if (k.state.fatArrowAt == k.stream.start) {
            var r = n ? Y : q;
            if ("(" == e) return S(j, N(")"), re(je, ")"), I, F("=>"), r, _);
            if ("variable" == e) return C(j, be, F("=>"), r, _);
          }

          var i = n ? U : V;
          return b.hasOwnProperty(e) ? S(i) : "function" == e ? S(Le, i) : "class" == e || c && "interface" == t ? (k.marked = "keyword", S(N("form"), Ee, I)) : "keyword c" == e || "async" == e ? S(n ? P : z) : "(" == e ? S(N(")"), B, F(")"), I, i) : "operator" == e || "spread" == e ? S(n ? P : z) : "[" == e ? S(N("]"), Ve, I, i) : "{" == e ? ie(ee, "}", null, i) : "quasi" == e ? C(G, i) : "new" == e ? S(function (e) {
            return function (t) {
              return "." == t ? S(e ? J : X) : "variable" == t && c ? S(me, e ? U : V) : C(e ? P : z);
            };
          }(n)) : "import" == e ? S(z) : S();
        }

        function B(e) {
          return e.match(/[;\}\)\],]/) ? C() : C(z);
        }
        ...
        function U(e, t, n) {
          var r = 0 == n ? V : U,
              i = 0 == n ? z : P;
          return "=>" == e ? S(j, n ? Y : q, _) : "operator" == e ? /\+\+|--/.test(t) || c && "!" == t ? S(r) : c && "<" == t && k.stream.match(/^([^<>]|<[^<>]*>)*>\s*\(/, !1) ? S(N(">"), re(ue, ">"), I, r) : "?" == t ? S(z, F(":"), i) : S(i) : "quasi" == e ? C(G, r) : ";" != e ? "(" == e ? ie(P, ")", "call", r) : "." == e ? S(Z, r) : "[" == e ? S(N("]"), B, F("]"), I, r) : c && "as" == t ? (k.marked = "keyword", S(ue, r)) : "regexp" == e ? (k.state.lastType = k.marked = "operator", k.stream.backUp(k.stream.pos - k.stream.start - 1), S(i)) : void 0 : void 0;
        }

        function G(e, t) {
          return "quasi" != e ? C() : "${" != t.slice(t.length - 2) ? S(G) : S(z, K);
        }
        ...
        function q(e) {
          return y(k.stream, k.state), C("{" == e ? R : z);
        }

        function Y(e) {
          return y(k.stream, k.state), C("{" == e ? R : P);
        }
        ...
        function ee(e, t) {
          return "async" == e ? (k.marked = "property", S(ee)) : "variable" == e || "keyword" == k.style ? (k.marked = "property", "get" == t || "set" == t ? S(te) : (c && k.state.fatArrowAt == k.stream.start && (n = k.stream.match(/^\s*:\s*/, !1)) && (k.state.fatArrowAt = k.stream.pos + n[0].length), S(ne))) : "number" == e || "string" == e ? (k.marked = s ? "property" : k.style + " property", S(ne)) : "jsonld-keyword" == e ? S(ne) : c && D(t) ? (k.marked = "keyword", S(ee)) : "[" == e ? S(z, ae, F("]"), ne) : "spread" == e ? S(P, ne) : "*" == t ? (k.marked = "keyword", S(ee)) : ":" == e ? C(ne) : void 0;
          var n;
        }
        ...
        function le(e) {
          if (c && ":" == e) return k.stream.match(/^\s*\w+\s+is\b/, !1) ? S(z, ce, ue) : S(ue);
        }
        ...
        function ue(e, t) {
          return "keyof" == t || "typeof" == t || "infer" == t ? (k.marked = "keyword", S("typeof" == t ? P : ue)) : "variable" == e || "void" == t ? (k.marked = "type", S(pe)) : "|" == t || "&" == t ? S(ue) : "string" == e || "number" == e || "atom" == e ? S(pe) : "[" == e ? S(N("]"), re(ue, "]", ","), I, pe) : "{" == e ? S(N("}"), re(fe, "}", ",;"), I, pe) : "(" == e ? S(re(he, ")"), de, pe) : "<" == e ? S(re(ue, ">"), ue) : void 0;
        }
        ...
        function fe(e, t) {
          return "variable" == e || "keyword" == k.style ? (k.marked = "property", S(fe)) : "?" == t || "number" == e || "string" == e ? S(fe) : ":" == e ? S(ue) : "[" == e ? S(F("variable"), se, F("]"), fe) : "(" == e ? C(Te, fe) : void 0;
        }

        function he(e, t) {
          return "variable" == e && k.stream.match(/^\s*[?:]/, !1) || "?" == t ? S(he) : ":" == e ? S(ue) : "spread" == e ? S(he) : C(ue);
        }

        function pe(e, t) {
          return "<" == t ? S(N(">"), re(ue, ">"), I, pe) : "|" == t || "." == e || "&" == t ? S(ue) : "[" == e ? S(ue, F("]"), pe) : "extends" == t || "implements" == t ? (k.marked = "keyword", S(ue)) : "?" == t ? S(ue, F(":"), ue) : void 0;
        }

        function me(e, t) {
          if ("<" == t) return S(N(">"), re(ue, ">"), I, pe);
        }
        ...
        function ye(e, t) {
          return "enum" == t ? (k.marked = "keyword", S(Ue)) : C(be, ae, ke, Ce);
        }

        function be(e, t) {
          return c && D(t) ? (k.marked = "keyword", S(be)) : "variable" == e ? (M(t), S()) : "spread" == e ? S(be) : "[" == e ? ie(we, "]") : "{" == e ? ie(xe, "}") : void 0;
        }

        function xe(e, t) {
          return "variable" != e || k.stream.match(/^\s*:/, !1) ? ("variable" == e && (k.marked = "property"), "spread" == e ? S(be) : "}" == e ? C() : "[" == e ? S(z, F("]"), F(":"), xe) : S(F(":"), be, ke)) : (M(t), S(ke));
        }
        ...
        function Ae(e, t) {
          return "await" == t ? S(Ae) : "(" == e ? S(N(")"), Me, I) : void 0;
        }

        function Me(e) {
          return "var" == e ? S(ye, De) : "variable" == e ? S(De) : C(De);
        }

        function De(e, t) {
          return ")" == e ? S() : ";" == e ? S(De) : "in" == t || "of" == t ? (k.marked = "keyword", S(z, De)) : C(z, De);
        }

        function Le(e, t) {
          return "*" == t ? (k.marked = "keyword", S(Le)) : "variable" == e ? (M(t), S(Le)) : "(" == e ? S(j, N(")"), re(je, ")"), I, le, R, _) : c && "<" == t ? S(N(">"), re(ge, ">"), I, Le) : void 0;
        }

        function Te(e, t) {
          return "*" == t ? (k.marked = "keyword", S(Te)) : "variable" == e ? (M(t), S(Te)) : "(" == e ? S(j, N(")"), re(je, ")"), I, le, _) : c && "<" == t ? S(N(">"), re(ge, ">"), I, Te) : void 0;
        }

        function Oe(e, t) {
          return "keyword" == e || "variable" == e ? (k.marked = "type", S(Oe)) : "<" == t ? S(N(">"), re(ge, ">"), I) : void 0;
        }

        function je(e, t) {
          return "@" == t && S(z, je), "spread" == e ? S(je) : c && D(t) ? (k.marked = "keyword", S(je)) : c && "this" == e ? S(ae, ke) : C(be, ae, ke);
        }

        function Ee(e, t) {
          return "variable" == e ? _e(e, t) : Ne(e, t);
        }

        function _e(e, t) {
          if ("variable" == e) return M(t), S(Ne);
        }

        function Ne(e, t) {
          return "<" == t ? S(N(">"), re(ge, ">"), I, Ne) : "extends" == t || "implements" == t || c && "," == e ? ("implements" == t && (k.marked = "keyword"), S(c ? ue : z, Ne)) : "{" == e ? S(N("}"), Ie, I) : void 0;
        }

        function Ie(e, t) {
          return "async" == e || "variable" == e && ("static" == t || "get" == t || "set" == t || c && D(t)) && k.stream.match(/^\s+[\w$\xa1-\uffff]/, !1) ? (k.marked = "keyword", S(Ie)) : "variable" == e || "keyword" == k.style ? (k.marked = "property", S(Fe, Ie)) : "number" == e || "string" == e ? S(Fe, Ie) : "[" == e ? S(z, ae, F("]"), Fe, Ie) : "*" == t ? (k.marked = "keyword", S(Ie)) : c && "(" == e ? C(Te, Ie) : ";" == e || "," == e ? S(Ie) : "}" == e ? S() : "@" == t ? S(z, Ie) : void 0;
        }
        ...
        function Fe(e, t) {
          ...
          return C(n && "interface" == n.info ? Te : Le);
        }

        function Re(e, t) {
          return "*" == t ? (k.marked = "keyword", S(Be, F(";"))) : "default" == t ? (k.marked = "keyword", S(z, F(";"))) : "{" == e ? S(re(We, "}"), Be, F(";")) : C(R);
        }

        function We(e, t) {
          return "as" == t ? (k.marked = "keyword", S(F("variable"))) : "variable" == e ? C(P, We) : void 0;
        }

        function ze(e) {
          return "string" == e ? S() : "(" == e ? C(z) : C(Pe, $e, Be);
        }

        function Pe(e, t) {
          return "{" == e ? ie(Pe, "}") : ("variable" == e && M(t), "*" == t && (k.marked = "keyword"), S(He));
        }
        ...
        function Be(e, t) {
          if ("from" == t) return k.marked = "keyword", S(z);
        }
        ...
        function Ue() {
          return C(N("form"), be, F("{"), N("}"), re(Ge, "}"), I, I);
        }
        ...
        return _.lex = !0, I.lex = !0, {
          ...
          token: function (e, t) {
            ...
            return "comment" == r ? n : (t.lastType = "operator" != r || "++" != i && "--" != i ? r : "incdec", function (e, t, n, r, i) {
              ...
              for (k.state = e, k.stream = i, k.marked = null, k.cc = o, k.style = t, e.lexical.hasOwnProperty("align") || (e.lexical.align = !0);;) if ((o.length ? o.pop() : l ? z : R)(n, r)) {
          ...
          indent: function (t, r) {
            ...
            if (!/^\s*else\b/.test(r)) for (var c = t.cc.length - 1; c >= 0; --c) {
              var u = t.cc[c];
              if (u == I) l = l.prev;else if (u != Se) break;
            }
            ...
            }(t, r) ? a || o : 0) : "switch" != l.info || h || 0 == n.doubleIndentSwitch ? l.align ? l.column + (h ? 0 : 1) : l.indented + (h ? 0 : o) : l.indented + (/^(?:case|default)\b/.test(r) ? o : 2 * o);
          },
    ...
    !function (e) {
      ...
      function r(t, r, i, o) {
        var a = function (t, n, r) {
          ...
          return i.className = "CodeMirror-lint-tooltip cm-s-" + t.options.theme, i.appendChild(r.cloneNode(!0)), t.state.lint.options.selfContain ? t.getWrapperElement().appendChild(i) : document.body.appendChild(i), e.on(document, "mousemove", o), o(n), null != i.style.opacity && (i.style.opacity = 1), i;
        }(t, r, i);

        function s() {
          var t;
          e.off(o, "mouseout", s), a && ((t = a).parentNode && (null == t.style.opacity && n(t), t.style.opacity = 0, setTimeout(function () {
            n(t);
          }, 600)), a = null);
        }
      ...
      function a(t, n, i, o, a) {
        var s = document.createElement("div"),
            l = s;
        return s.className = "CodeMirror-lint-marker-" + i, o && ((l = s.appendChild(document.createElement("div"))).className = "CodeMirror-lint-marker-multiple"), 0 != a && e.on(l, "mouseover", function (e) {
          r(t, e, n, l);
        }), s;
      }
      ...
      function c(e, n) {
        ...
        for (var r, i, l = e.state.lint, c = l.options, u = function (e) {
          ...
          if (f) {
            for (var h = null, p = l.hasGutter && document.createDocumentFragment(), m = 0; m < f.length; ++m) {
              var g = f[m],
                  v = g.severity;
              v || (v = "error"), i = v, h = "error" == (r = h) ? r : i, c.formatAnnotation && (g = c.formatAnnotation(g)), l.hasGutter && p.appendChild(s(g)), g.to && l.marked.push(e.markText(g.from, g.to, {
                className: "CodeMirror-lint-mark-" + v,
                __annotation: g
              }));
            }

            l.hasGutter && e.setGutterMarker(d, t, a(e, p, h, f.length > 1, l.options.tooltips));
          }
        }
      ...
      e.defineOption("lint", !1, function (n, r, a) {
        if (a && a != e.Init && (o(n), !1 !== n.state.lint.options.lintOnChange && n.off("change", u), e.off(n.getWrapperElement(), "mouseover", n.state.lint.onMouseOver), clearTimeout(n.state.lint.timeout), delete n.state.lint), r) {
          ...
          var f = n.state.lint = new i(n, (h = r) instanceof Function ? {
            getAnnotations: h
          } : (h && !0 !== h || (h = {}), h), c);
    ...
    S["[object Arguments]"] = S["[object Array]"] = S["[object ArrayBuffer]"] = S["[object DataView]"] = S["[object Boolean]"] = S["[object Date]"] = S["[object Float32Array]"] = S["[object Float64Array]"] = S["[object Int8Array]"] = S["[object Int16Array]"] = S["[object Int32Array]"] = S["[object Map]"] = S["[object Number]"] = S["[object Object]"] = S["[object RegExp]"] = S["[object Set]"] = S["[object String]"] = S["[object Symbol]"] = S["[object Uint8Array]"] = S["[object Uint8ClampedArray]"] = S["[object Uint16Array]"] = S["[object Uint32Array]"] = !0, S["[object Error]"] = S["[object Function]"] = S["[object WeakMap]"] = !1, e.exports = function e(t, n, A, M, D, L) {
      var T,
          ...
          j = 2 & n,
          E = 4 & n;
      if (A && (T = D ? A(t, M, D, L) : A(t)), void 0 !== T) return T;
      if (!w(t)) return t;

      var _ = y(t);

      if (_) {
        if (T = m(t), !O) return c(t, T);
      } else {
        var N = p(t),
            I = "[object Function]" == N || "[object GeneratorFunction]" == N;
        if (b(t)) return l(t, O);

        if ("[object Object]" == N || "[object Arguments]" == N || I && !D) {
          if (T = j || I ? {} : v(t), !O) return j ? d(t, s(T, t)) : u(t, a(T, t));
        } else {
          if (!S[N]) return D ? t : {};
          T = g(t, N, O);
        }
      ...
      var F = L.get(t);
      if (F) return F;
      L.set(t, T), k(t) ? t.forEach(function (r) {
        T.add(e(r, n, A, r, t, L));
      }) : x(t) && t.forEach(function (r, i) {
        T.set(i, e(r, n, A, i, t, L));
      });
      var R = E ? j ? h : f : j ? keysIn : C,
          W = _ ? void 0 : R(t);
      return i(W || t, function (r, i) {
        W && (r = t[i = r]), o(T, i, e(r, n, A, i, t, L));
      }), T;
    };
  }, function (e, t, n) {
    var r = n(16),
    ...
    var a = {
      ...
      mounted() {
        this.jsonEditor = o.a.fromTextArea(this.$refs.textarea, {
          lineNumbers: !0,
          ...
          lint: !0
        }), this.jsonEditor.setValue(JSON.stringify(this.value, null, 2)), this.jsonEditor.on("change", e => {
      ...
      methods: {
        ...
        s = (n(73), n(1)),
        l = Object(s.a)(a, r, [], !1, null, "d3ee32fc", null);
    l.options.__file = "lib/json-editor/src/json-editor.vue";
    var c = l.exports;
    ...
    var u = c,
      ...
      var e = this,
          t = e.$createElement,
          n = e._self._c || t;
      return n("div", [e.showRaw ? n("el-button", {
        staticStyle: {
          "margin-bottom": "10px"
        },
        attrs: {
        ...
        on: {
          click: e.handleReqBodyRaw
        }
      }, [e._v("RAW查看")]) : e._e(), n("div", {
      ...
      }, ["object" === e.schemaData.type ? n("span", {
        staticClass: "down-style",
        on: {
          click: e.handleClickIcon
        }
        ...
        staticClass: "type-select-style",
        attrs: {
          value: e.schemaData.type,
          disabled: e.schemaData.disabled && !e.schemaData.canChangeType,
          size: "small"
        },
        on: {
          change: function (t) {
        ...
        attrs: {
          placeholder: "标题",
          disabled: e.schemaData.disabled,
          size: "small"
        },
        model: {
        ...
        on: {
          click: function (t) {
            return e.handleSchemaUpdateEvent({
              eventType: "show-edit",
              field: "title",
              prefix: ["properties"],
              isRoot: !0
        ...
        attrs: {
          placeholder: "默认值",
          size: "small",
          disabled: "object" === e.schemaData.type || "array" === e.schemaData.type || e.schemaData.disabled
        },
        model: {
        ...
        model: {
          value: e.schemaData.description,
          callback: function (t) {
            e.$set(e.schemaData, "description", t);
          },
          expression: "schemaData.description"
        }
      }, [n("i", {
        staticClass: "el-icon-edit",
        attrs: {
        ...
        staticClass: "el-icon-setting"
      })])], 1), "object" === e.schemaData.type ? n("span", {
        on: {
          click: function (t) {
            return e.handleSchemaUpdateEvent({
              eventType: "add-field",
      ...
      }) : e._e(), e.showRaw ? n("RawDialog", {
        attrs: {
          visible: e.rawDialogVisible,
          schema: e.schemaData
        },
        on: {
        ...
        attrs: {
          visible: e.basicDialogVisible,
          "init-data": e.basicModalData
        },
        on: {
          "update:visible": function (t) {
        ...
        attrs: {
          visible: e.settingDialogVisible.string,
          "init-data": e.settingModalData
        },
        on: {
          "update:visible": function (t) {
        ...
        attrs: {
          visible: e.settingDialogVisible.number,
          "init-data": e.settingModalData
        },
        on: {
          "update:visible": function (t) {
        ...
        attrs: {
          visible: e.settingDialogVisible.integer,
          "init-data": e.settingModalData
        },
        on: {
          "update:visible": function (t) {
        ...
        attrs: {
          visible: e.settingDialogVisible.array,
          "init-data": e.settingModalData
        },
        on: {
          "update:visible": function (t) {
        ...
        attrs: {
          visible: e.settingDialogVisible.boolean,
          "init-data": e.settingModalData
        },
        on: {
          "update:visible": function (t) {
        ...
        attrs: {
          visible: e.settingDialogVisible.object,
          "init-data": e.settingModalData
        },
        on: {
          "update:visible": function (t) {
    ...
    var f = n(4),
      ...
      }, "div", e.$attrs, !1), ["array" === e.data.type ? [n("schema-array", {
        attrs: {
          prefix: e.name,
          data: e.data,
          "is-mock": e.isMock,
      ...
      })] : e._e(), "object" === e.data.type ? [n("schema-object", {
        attrs: {
          prefix: e.nameArray,
          data: e.data,
          "is-mock": e.isMock,
    ...
    var w = n(22),
      ...
      methods: {}
        ...
        C = Object(s.a)(k, x, [], !1, null, null, null);
    C.options.__file = "lib/json-schema-editor/src/Schema/index.vue";
    var S = C.exports,
        A = n(21),
        M = (n(156), function () {
      var e = this,
    ...
    var D = {
      ...
      methods: {
        ...
        handleOk() {
          this.initData.value = this.data, this.$event.emit("schema-update-" + this.initData.editorId, {
        ...
        L = Object(s.a)(D, M, [], !1, null, "704c85e6", null);
    L.options.__file = "lib/json-schema-editor/src/dialog/BasicDialog.vue";
    ...
    var T = L.exports,
      ...
      var e = this,
          t = e.$createElement,
          n = e._self._c || t;
      return n("div", [n("el-dialog", e._g(e._b({
        attrs: {
          title: "基础设置（字符串）",
          width: "700px"
        },
      ...
      }, "el-dialog", e.$attrs, !1), e.$listeners), [n("el-row", {
        attrs: {
          gutter: 15
        }
      }, [n("el-form", {
      ...
      methods: {
        ...
        handleConfirm() {
          this.$refs.elForm.validate(e => {
            if (!e) return;
            const t = Object(_.g)(this.formData);
            t.enum && (t.enum = E()(t.enum.split("\n"))), this.$event.emit("schema-update-" + this.initData.editorId, {
        ...
        I = Object(s.a)(N, O, [], !1, null, null, null);

    I.options.__file = "lib/json-schema-editor/src/dialog/StringDialog.vue";
      ...
      methods: {
        ...
        handleConfirm() {
          this.$refs.elForm.validate(e => {
            if (!e) return;
            const t = Object(_.g)(this.formData);
            t.enum && (t.enum = E()(t.enum.split("\n"))), t.default && (t.default = Number(t.default)), this.$event.emit("schema-update-" + this.initData.editorId, {
              eventType: "save-setting",
              ...this.initData,
              newData: t
            }), this.close();
        ...
        z = Object(s.a)(W, R, [], !1, null, null, null);
    z.options.__file = "lib/json-schema-editor/src/dialog/NumberDialog.vue";
    ...
    var H = {
      ...
      methods: {
        ...
        B = Object(s.a)(H, $, [], !1, null, null, null);
    B.options.__file = "lib/json-schema-editor/src/dialog/ArrayDialog.vue";
    ...
    var V = B.exports,
      ...
      }, "el-dialog", e.$attrs, !1), e.$listeners), [n("el-form", {
        ref: "elForm",
        attrs: {
          model: e.formData,
          size: "small",
    ...
    var G = {
      ...
      methods: {
        ...
        K = Object(s.a)(G, U, [], !1, null, null, null);
    K.options.__file = "lib/json-schema-editor/src/dialog/BooleanDialog.vue";
    ...
    var X = {
      ...
      methods: {
        ...
        J = Object(s.a)(X, Y, [], !1, null, null, null);
    J.options.__file = "lib/json-schema-editor/src/dialog/ObjectDialog.vue";
    ...
    var Q = J.exports,
      ...
      }, "el-dialog", e.$attrs, !1), e.$listeners), [n("div", {
    ...
    var ee = {
      ...
      methods: {
        ...
        te = Object(s.a)(ee, Z, [], !1, null, "53f27c47", null);
    te.options.__file = "lib/json-schema-editor/src/dialog/RawDialog.vue";
    var ne = te.exports,
        re = {
      ...
      mounted() {
        Object(_.i)(this, this.schemaData), this.$event.on("schema-update-" + this.editorId, this.handleSchemaUpdateEvent);
      },

      beforeDestroy() {
        this.$event.off("schema-update-" + this.editorId, this.handleSchemaUpdateEvent);
      },
      ...
      methods: {
        ...
        requireAllAction(e) {
          const {
            ...
            required: n
                ...
                r = Object(_.c)(t);
          Object(_.h)(r, n), this.forceUpdate(r), this.handleEmitChange(r);
        },
        ...
        enableRequireAction(e) {
          ...
          let l = null;
          l = a ? m()(s, a) : s;
          const c = [].concat(l.required || []),
                u = c.indexOf(n);
          !r && u >= 0 ? (c.splice(u, 1), o.push("required"), 0 === c.length ? Object(_.f)(s, o) : h()(s, o, c)) : r && -1 === u && (c.push(n), o.push("required"), h()(s, o, c)), this.forceUpdate(s), this.handleEmitChange(s);
        },
        ...
        addFieldAction(e) {
          ...
          if (t) {
            const e = [].concat(r, n);
            i = e.concat("properties").join(_.a), o = [...e];
          } else {
            i = r.join(_.a);
            const e = [].concat(r);
            e.pop(), o = e;
          ...
          Object(_.i)("addFieldAction>>>", i, "\n\t");
          let a = {};
          const s = "field_" + Object(_.j)(),
                l = m()(this.schemaData, i);
          a = Object.assign({}, l), a[s] = _.e.string;
          const c = b()(this.schemaData);
          h()(c, i, a);
          let u = null;
          u = o.length ? m()(c, o) : c;
          const d = [].concat(u.required || []);
          d.push(s), o.push("required"), h()(c, o, d), this.schemaData = c, this.forceUpdate(c), this.handleEmitChange(c);
        },
        ...
        deleteFieldAction(e) {
          const {
            ...
            prefix: n
                ...
                r = [].concat(n, t).join(_.a),
                i = b()(this.schemaData);
          v()(i, r), this.schemaData = i, this.forceUpdate(), this.handleEmitChange(i);
        },
        ...
        updateFieldNameAction(e) {
          ...
          o.pop(), i = o;
          const a = r.join(_.a),
                s = r.concat(n).join(_.a),
                l = b()(this.schemaData),
                c = m()(l, s);
          v()(l, s), h()(l, `${a}.${t}`, c);
          let u = null;
          u = i.length ? m()(l, i) : l;
          let d = [].concat(u.required || []);
          d = d.map(e => e === n ? t : e), i.push("required"), h()(l, i, d), this.schemaData = l, this.forceUpdate(), this.handleEmitChange(l);
        },

        handleChangeType2(e) {
          this.schemaData.type = e;
          const t = this.schemaData.description ? {
        ...
        handleChangeType(e) {
          ...
          const {
            ...
            description: a.description
                ...
                c = Object.assign({}, s, l);
          h()(o, i, c), this.schemaData = o, this.forceUpdate(), this.handleEmitChange(o);
        },
        ...
        handleShowEdit(e) {
          ...
          let o;
          if (Object(_.i)(this, "handleShowEdit", n, r), i) o = this.schemaData;else {
            const e = [].concat(r, n);
            o = m()(this.schemaData, e);
          }
          "default" === t && "array" === o.type || "object" === o.type || (this.basicDialogVisible = !0, Object.assign(this.basicModalData, {
            title: "title" === t ? "标题" : "default" === t ? "默认值" : "描述",
            value: o[t],
        ...
        handleSaveShowEdit(e) {
          ...
          let a;
          const s = b()(this.schemaData);
          o ? s[n] = t : (a = [].concat(i, r, n), h()(s, a, t)), this.schemaData = s, this.forceUpdate(), this.handleEmitChange(s);
        },
        ...
        handleSettingAction(e) {
          ...
          let o;
          if (this.settingDialogVisible[t] = !0, i) o = this.schemaData;else {
            const e = [].concat(r, n);
            o = m()(this.schemaData, e);
          }
        ...
        handleSaveSetting(e) {
          const {
            ...
            isRoot: i
                ...
                o = b()(this.schemaData);
          if (console.log(i), i) Object.assign(o, { ...r
          });else {
            const e = [].concat(n, t),
                  i = m()(o, e);
            h()(o, e, { ...i,
          ...
          this.schemaData = o, this.forceUpdate(), this.handleEmitChange(o);
        },
        ...
        ie = Object(s.a)(re, d, [], !1, null, null, null);
    ie.options.__file = "lib/json-schema-editor/src/json-schema-editor.vue";
    var oe = ie.exports;
